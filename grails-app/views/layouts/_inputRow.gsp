<div class="row">
    <div class="col-4">
        <div class="checkBox">
            <g:checkBox disabled="true" class="momentCheck" name="${moment}"/>&nbsp;<g:message
    ...
    <div class="col">
        ...
        <g:if test="${moment != 'inoff'}">
            <g:checkBox class="klassCheck" checked="${checkMap[moment + '_elit']}"
                        name="${moment}_elit"/>&nbsp;<g:message
